# -*- coding: utf-8 -*-
"""
Created on Tue May  7 20:38:45 2019
...
def load_assets(img_dir, snd_dir, fnt_dir):
    ...
    assets["player_img"] = pygame.image.load(path.join(img_dir, "player2.png")).convert()
...
while exit_program != True:
    ...
    if game_over:
        text=score_font.render("Game Over", 1, (200, 200, 200))
